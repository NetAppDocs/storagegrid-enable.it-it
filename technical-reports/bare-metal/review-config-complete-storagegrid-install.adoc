...
+
image:bare-metal-summary-page.png["pagina-di-riepilogo-bare-metal"]
...
+
image:bare-metal-download-recovery-package.png["pacchetto-ripristino-download-bare-metal"]
...
+
image:bare-metal-installation-status.png["stato-installazione-bare-metal"]
