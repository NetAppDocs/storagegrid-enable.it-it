...
image:monitor-metrics-page.png["pagina-metriche-monitor"]

In alternativa, è possibile accedere direttamente al collegamento.

image:monitor-prometheus-interface.png["interfaccia monitor-prometheus"]
...
+
image:monitor-http-sessions.png["monitorare-sessioni-http"]
...
+
image:monitor-metrics-query.png["monitoraggio-metriche-query"]
...
+
image:monitor-sample-prometheus-query-responses.png["monitorare-campione-prometheus-risposte-query"]
