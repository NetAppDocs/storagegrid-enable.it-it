...
[role="lead"]
Nell'operazione Aux Copy, quattro Commvault MediaAgents hanno eseguito il backup dei dati su un sistema NetApp AFF A300 e una copia ausiliaria è stata creata su NetApp StorageGRID.
