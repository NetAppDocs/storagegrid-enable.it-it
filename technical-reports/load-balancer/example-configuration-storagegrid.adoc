...
+
image:load-balancer-monitor-configuration-page.png["Pagina di configurazione del monitor"]
...
image:load-balancer-citrix-netscaler-configuration-page.png["Pagina di configurazione di Citrix Netscaler Monitor"]
