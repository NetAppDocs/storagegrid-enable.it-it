...
. Controlla la  https://docs.cloudera.com/cdp-private-cloud-upgrade/latest/upgrade/topics/cdpdc-java-requirements.html["Matrice di supporto di Cloudera"^] per la versione di JDK supportata.
