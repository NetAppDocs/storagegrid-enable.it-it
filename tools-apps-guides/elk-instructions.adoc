...
image::logstash-7.17.fields-sample.png[Esempio di Logstash 7.17]

*Esempio di Logstash 8.23*

image::logstash-8.x.fields-sample.png[Esempio di Logstash 8.23]
...
+
image::kibana-import-options.png[Opzioni di importazione Kibana]
...
+
image::kibana-import-conflict.png[Conflitto di Kibana]
