...
image::obj_lock_en.png[Blocco oggetti larghi griglia attivato]
...
image::bucket_consist_2.png[Consistenza della benna]
...
image::tc_policy.png[Crea criterio TC]
...
image::veeam_concur_limit.png[Limite attività concorrente Veeam]
...
image::veeam_1.png[Processo di backup]
...
image::veeam_blk_sz.png[Schermata della descrizione di un computer generata automaticamente,320,375]
...
Immagine::S3_over_rates.png[Panoramica tassi S3]
...
image::s3_over_duration.png[S3 durata della panoramica]
...
image::s3_over_requests.png[S3 Richieste di panoramica]
...
image::ilm_delete.png[Eliminazione ILM]
...
image::tc_1.png[Criteri di classificazione del traffico]

image::tc_2.png[Criteri di classificazione del traffico]
